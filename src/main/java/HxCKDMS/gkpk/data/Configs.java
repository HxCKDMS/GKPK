...
public class Configs {
    ...
    static {
        ...
        drugs.putIfAbsent("solan", new Drug("Solanine", 0x825535, "blobs", TimeConst.TICKS_PER_MINUTE, 4, new Drug.dummyPot(Potion.poison.getId(), TimeConst.TICKS_PER_MINUTE * 2, 4))); // Potato poison
